...
global.visitor_database = [
    ...
    
    {
        ...
        article_type: ".", article_text: "Nudity should be socaily aceptible says 10/10 people on the street, running a screaming from them now seen as socaily unaceptable.",
